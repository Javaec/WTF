...
WeakAurasSaved = {
	["dynamicIconCache"] = {
		...
		["Затягивающая сингулярность"] = {
			[232974] = 135735,
		},
		["Токсичные объедки"] = {
			[206798] = 1353663,
		},
		["Несовершенная физиология"] = {
			[263436] = 237587,
		},
		["Пророческий луч"] = {
			[209244] = 135730,
	...
	["displays"] = {
			...
			["triggers"] = {
				{
					["trigger"] = {
						...
						["duration"] = "1",
						["realSpellName"] = "Отвар железной шкуры",
						["use_spellName"] = true,
						["spellIds"] = {
						},
						["spellName"] = 115308,
			...
			["triggers"] = {
				{
					...
					["untrigger"] = {
						["custom"] = "function(event)\n    \n    if event == \"ENCOUNTER_START\" or event == \" ENCOUNTER_END\" or event == \"PLAYER_REGEN_ENABLED\" or event == \"UNIT_EXITED_VEHICLE\" then \n        aura_env.name = \"\"\n        return true\n    end\nend\n\n\n\n\n\n",
					},
				}, -- [1]
				{
					["trigger"] = {
		...
		["Purple"] = {
			...
			["actions"] = {
				["start"] = {
					["custom"] = "aura_env.region:SetScript(\"OnMouseDown\", function(self,...) \n        SendChatMessage(\"MH: PURPLE\",\"WHISPER\",_,UnitName(\"target\"))\nend)",
					["do_custom"] = true,
				},
				["finish"] = {
					["custom"] = "aura_env.region:SetScript(\"OnMouseDown\", nil)",
				...
				["init"] = {
					["custom"] = "MekatorkHelperWeakAura = MekatorkHelperWeakAura or {}\nMekatorkHelperWeakAura.code = MekatorkHelperWeakAura.code or {}",
					["do_custom"] = false,
				},
			},
			["text2Font"] = "Friz Quadrata TT",
		...
		["Отвар Же"] = {
			...
			["controlledChildren"] = {
				"Отвар железной шкуры", -- [1]
				"Отвар железной шкуры 2", -- [2]
			},
			["borderBackdrop"] = "Blizzard Tooltip",
			["xOffset"] = -17.0770263671875,
			["border"] = false,
			["borderEdge"] = "None",
			["regionType"] = "group",
			["borderSize"] = 16,
			...
			["triggers"] = {
				...
				}, -- [1]
				{
					["trigger"] = {
						["custom_type"] = "status",
						["type"] = "custom",
						["custom"] = "function() return UnitIsUnit(\"boss2target\", \"player\") end",
						["subeventSuffix"] = "_CAST_START",
						["check"] = "update",
						["event"] = "Health",
						["genericShowOn"] = "showOnActive",
		...
		["Mekkatorque Announcer"] = {
			...
			["controlledChildren"] = {
				"Mekkatorque Tampering", -- [1]
				"Mekkatorque Shrunk", -- [2]
			},
			["borderBackdrop"] = "Blizzard Tooltip",
			["scale"] = 1,
			["border"] = false,
